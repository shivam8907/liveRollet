...
public class DatePicker : MonoBehaviour {
    ...
    public void GenerateDaysNames(){
        ...
        for (int d = 1; d <= 7; d++){       
            ...
            DayNameLabel.transform.SetParent(DayContainer.transform); DayNameLabel.transform.localScale = Vector3.one;
    ...
    public void GenerateDaysToggles(){
        for (int i = 0; i < DayToggles.Length; i++){
            ...
            DayToggle.transform.SetParent(DayContainer.transform); DayToggle.transform.localScale = Vector3.one;
